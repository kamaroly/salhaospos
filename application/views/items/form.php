...
<div class="field_row clearfix">
<?php echo form_label($this->lang->line('items_whole_price').':', 'unit_price',array('class'=>'required wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'whole_price',
		'size'=>'8',
		'id'=>'whole_price',
		'value'=>$item_info->whole_price)
	);?>
	</div>
</div>
<div class="field_row clearfix">
...
/** END GARRISON ADDED **/
	...
	$('#item_form').validate({
		...
		messages:
		{
		   ...
		   whole_price:
			{
				required:"<?php echo $this->lang->line('items_whole_price_required'); ?>",
				number:"<?php echo $this->lang->line('items_whole_price_number'); ?>"
			},
			tax_percent:
			{
