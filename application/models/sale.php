...
class Sale extends CI_Model
{
	...
	public function create_sales_items_temp_table()
	{
		...
		(item_unit_price*quantity_purchased-discount_percent)*(1+(SUM(percent)/100)) as total,
		(item_unit_price*quantity_purchased-discount_percent)*(SUM(percent)/100) as tax,
